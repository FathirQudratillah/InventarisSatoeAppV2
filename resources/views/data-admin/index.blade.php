                        ...
                        <li>
                            <a href="{{ route('data-akun.create') }}"
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400">Tambah admin baru</p>
                                </div>
                            </a>
                        </li>
                    </ul>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($admins as $admin)
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-2 md:px-6 md:py-3 text-sm text-gray-700">{{ $admin->nip }}</td>
                                <td class="px-4 py-2 md:px-6 md:py-3 text-sm text-gray-700">{{ $admin->user_id }}</td>
                                <td class="px-4 py-2 md:px-6 md:py-3 text-sm text-gray-700">{{ $admin->nama }}</td>
                                <td class="px-4 py-2 md:px-6 md:py-3 text-sm text-gray-700">{{ $admin->email }}</td>
                                <td class="px-4 py-2 md:px-6 md:py-3 text-sm text-gray-700">{{ $admin->no_kontak }}</td>
                                <td class="px-4 py-2 md:px-6 md:py-3 text-sm text-gray-700">{{ $admin->alamat }}</td>
                                    ...
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div class="dropdown-menu hidden absolute right-0 z-50 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl">
                                            ...
                                            <ul class="py-1 text-sm">
                                                ...
                                                <!-- Edit -->
                                                <li>
                                                    <a href="{{ route('data-akun.edit', $admin->nip) }}"
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-xs text-gray-400">Ubah data admin</p>
                                                        </div>
                                                    </a>
                                                </li>
                                                ...
                                                <!-- Delete -->
                                                <li>
                                                    <form action="{{ route('data-akun.destroy', $admin->nip) }}" method="POST"
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <div class="text-left">
                                                                ...
                                                                <p class="text-xs text-gray-400">Hapus data admin</p>
                                                            </div>
                                                        </button>
                                                    </form>
                                                </li>

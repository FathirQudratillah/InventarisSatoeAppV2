<x-layout type="login" title="Login">
        ...
        <div class="w-full max-w-md mx-auto bg-gray-800 border border-gray-700 rounded-2xl shadow-2xl px-8 py-10">
                ...
                <div class="flex items-center">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="remember" id="remember"
                            class="w-4 h-4 rounded border-gray-600 bg-gray-700 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-gray-800" />
            ...
            <!-- Footer -->
            <p class="mt-8 text-center text-xs text-gray-600">© {{ date('Y') }} InventarisSatoeApp</p>
        </div>
</x-layout>
